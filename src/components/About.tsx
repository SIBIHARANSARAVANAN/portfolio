      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              With experience as a AI Engineer at the Nexnora Technologies, I've developed 
              a strong foundation in AI concepts, visualization, and machine learning implementation. I'm 
