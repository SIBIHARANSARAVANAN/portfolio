          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  { icon: Mail, label: "sibiharansaravanan2002@gmail.com", href: "sibiharansaravanan2002@gmail.com", color: "from-red-400 to-pink-400" },
                  { icon: Phone, label: "91+8489941515", href: "91+8489941515", color: "from-green-400 to-blue-400" },
                  { icon: Github, label: "GitHub Profile", href: "https://github.com/SIBIHARANSARAVANAN", color: "from-gray-400 to-gray-600" },
                  { icon: Linkedin, label: "LinkedIn Profile", href: "https://www.linkedin.com/in/sibiharan-s-86087b358/", color: "from-blue-400 to-blue-600" }
                ].map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.href}
